					...
					<div class="col-md-6 ">
						...
						<div class="card-body text-primary ">
							...
							<div class="form-floating  mt-5 mb-3">
								<form:input path="name" type="text" class="form-control" value="${oneStudent.name}"
									id="floatingInput" placeholder="name@example.com" />
								<label for="floatingInput">Name</label>
							</div>
							<div class="form-floating mt-3 mb-3">
								<form:input path="address" type="text" class="form-control" value="${oneStudent.address}"
							...
							<div class="form-floating mt-3 mb-3">
								<form:input path="age" type="text" class="form-control" value="${oneStudent.age}"
									id="floatingInput" placeholder="Enter your Age" />
								<label for="floatingInput">Age</label>
							</div>
							
							<div class="form-floating mt-3 mb-3">
								<form:input path="dob" type="date" class="form-control" value="${oneStudent.dob}"
									id="floatingInput" placeholder="Enter Date of Birth" />
								<label for="floatingInput">Enter Date Of Birth</label>
							</div>
							
							<div class="form-floating mt-3 mb-3">
								<form:input path="rollnumber" type="text" class="form-control" value="${oneStudent.rollnumber}"
									id="floatingInput" placeholder="Enter Roll Number" />
								<label for="floatingInput">Enter Roll Number</label>
							</div>
							
							<div class="form-floating mt-3 mb-3">
								<form:input path="phone" type="text" class="form-control" value="${oneStudent.phone}"
